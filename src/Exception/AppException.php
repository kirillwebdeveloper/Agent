...
class AppException extends RuntimeException
{
     ...
     * @return AppException
     */
    public static function emptyProperty(string $method, string $property): AppException
    {
        $class = static::class;
     ...
     * @return AppException
     */
    public static function invalidArgument(string $method, string $argument, string $received, array $expected): AppException
    {
        $class = static::class;
